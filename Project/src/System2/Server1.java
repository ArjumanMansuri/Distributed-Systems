  ...
  class server1methods{
	...
	public static ArrayList<String> advisors=new ArrayList<>();
		...
		public  void default_values1()
		{
			...
			compfallstudent.put("comps1000", "comp1111");
...
public synchronized  int checkRegistration(String id) {
	...
	if(userType=='s'){
		if(System2.server1methods.compfallstudent.containsKey(id1) || server1methods.compwinterstudent.containsKey(id1) || server1methods.compsummerstudent.containsKey(id1))
		{
			return 1;
		}
		else
		...
		if (!server1methods.advisors.contains(id)) {
		return 0;
	}else
		return 1;
	}
