...
class server2methods{
	...
	public static ArrayList<String> advisors1=new ArrayList<>();
...
//	ArrayList<String> advisors=new ArrayList<>();
	...
	if(userType=='s'){
		if(server2methods.soenfallstudent.containsKey(id1) || server2methods.soenwinterstudent.containsKey(id1) || server2methods.soensummerstudent.containsKey(id1))
		{
			return 1;
		}
		else
		...
		if (!server2methods.advisors1.contains(id)) {
		return 0;
	}else
		return 1;
	}
