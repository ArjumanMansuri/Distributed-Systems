			...
			System.out.println("5. Exit");
				...
				case 1: System.out.println("Enter your student id");
				        ...
				        if(studentId.contains(COMP)){
				        	dcrsInterface = (Dcrs) DcrsHelper.narrow(ncRef.resolve_str("CompServer"));
				        }
				        else if(studentId.contains(SOEN)){
				        	dcrsInterface = (Dcrs) DcrsHelper.narrow(ncRef.resolve_str("SoenServer"));
				        }
				        else if(studentId.contains(INSE)){
				        	dcrsInterface = (Dcrs) DcrsHelper.narrow(ncRef.resolve_str("InseServer"));
				        }
