...
public class COMPServer{
	public static HashMap<String, HashMap<String, Course>> courses=new HashMap<>();
	...
	public static void main(String[] args) throws AlreadyBoundException, IOException {
		...
		Registry registry = LocateRegistry.createRegistry(1122);
		registry.bind("CompServer",compStub);
