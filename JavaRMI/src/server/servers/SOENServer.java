...
import bean.Course;
import server.interfaceImpl.DCRSImpl;

public class SOENServer {
	public static HashMap<String, HashMap<String, Course>> courses;
	public static HashMap<String, HashMap<String, ArrayList<String>>> students=new HashMap<>();
	...
	public static void main(String[] args) throws AlreadyBoundException, IOException {
		DCRSImpl compStub = new DCRSImpl();
		
		Registry registry = LocateRegistry.getRegistry(1122);
		registry.bind("SoenServer",compStub);
		...
		thread.start();
		System.out.println("Soen Server is started");
	}
